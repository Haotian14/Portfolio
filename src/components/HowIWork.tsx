...
export function HowIWork() {
  return (
    <section className="section work-section tone-invert" id="work">
      {/*
        The intro sticks within this grid only. The skills panel deliberately
        sits outside it: as a full-width row inside the same grid, the sticky
        intro would travel over it, because a sticky grid item is constrained
        by the grid container's content box rather than by its own grid area.
      */}
